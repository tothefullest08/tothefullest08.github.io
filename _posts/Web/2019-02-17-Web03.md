...
| ------------- | ------------------------------------------------------------ |
| [속성="값"]   | 특정한 값인 태그 선택                                        |
| [속성~="값"]  | 특정한 값을 단어로 포함하는 태그 선택 / 띄어쓰기 기준 (alt="바다 사진" / [alt~="바다"]) |
| [속성\|="값"] | 특정한 값을 단어로 포함하는 태그 선택 / 하이픈 기준 (alt="바다-사진" / [alt\|="바다") |
| [속성^="값"]  | 특정한 값으로 시작하는 태그 선택  (alt="apple banana" / [alt^="app"]) |
| [속성$="값"]  | 특정한 값으로 끝나는 태그 선택 (href="ssafy.com/istj" / [href$="istj"]) |
